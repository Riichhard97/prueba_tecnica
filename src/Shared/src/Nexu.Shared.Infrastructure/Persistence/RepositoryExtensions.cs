...
namespace Nexu.Shared.Infrastructure.Persistence
{
    public static class RepositoryExtensions
    {
        ...
        public static IQueryable<T> Query<T>(this IRepositoryBase repository)
            where T : class
        {
            return repository.Query(predicate: default, ignoreFilters: default, default(IEnumerable<Expression<Func<T, object>>>));
        }
        ...
        /// <paramref name="repository" /> is <c>null</c>
        /// </exception>
        public static IQueryable<T> Query<T>(this IRepositoryBase repository, bool ignoreFilters)
            where T : class
        {
            return repository.Query(predicate: default, ignoreFilters, default(IEnumerable<Expression<Func<T, object>>>));
        }
        ...
        public static IQueryable<T> Query<T>(this IRepositoryBase repository, params Expression<Func<T, object>>[] includes)
            where T : class
        {
            return repository.Query(default, default, includes);
        }
        ...
        /// <paramref name="repository" /> is <c>null</c>
        /// </exception>
        public static IQueryable<T> Query<T>(this IRepositoryBase repository, bool ignoreFilters, params Expression<Func<T, object>>[] includes)
            where T : class
        {
            return repository.Query(default, ignoreFilters, includes);
        }
        ...
        public static IQueryable<T> Query<T>(this IRepositoryBase repository, Expression<Func<T, bool>> predicate, params Expression<Func<T, object>>[] includes)
            where T : class
        {
            return repository.Query(predicate, default, includes);
        }
        ...
        /// <paramref name="repository" /> is <c>null</c>
        /// </exception>
        public static IQueryable<T> Query<T>(this IRepositoryBase repository, Expression<Func<T, bool>> predicate, bool ignoreFilters, params Expression<Func<T, object>>[] includes)
            where T : class
        {
            return repository.Query(predicate, ignoreFilters, includes);
        }
